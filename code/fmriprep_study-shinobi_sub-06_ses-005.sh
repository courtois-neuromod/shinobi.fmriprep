...
#SBATCH --job-name=fmriprep_study-shinobi_sub-06_ses-005.job
#SBATCH --output=/lustre03/project/6003287/datasets/cneuromod_processed/fmriprep/shinobi/code/fmriprep_study-shinobi_sub-06_ses-005.out
#SBATCH --error=/lustre03/project/6003287/datasets/cneuromod_processed/fmriprep/shinobi/code/fmriprep_study-shinobi_sub-06_ses-005.err
#SBATCH --time=5:00:00
...
if [ -e $LOCAL_DATASET/workdir/fmriprep_wf/resource_monitor.json ] ; then cp $LOCAL_DATASET/workdir/fmriprep_wf/resource_monitor.json /scratch/bpinsard/fmriprep_study-shinobi_sub-06_ses-005_resource_monitor.json ; fi 
if [ $fmriprep_exitcode -ne 0 ] ; then cp -R $LOCAL_DATASET /scratch/bpinsard/fmriprep_study-shinobi_sub-06_ses-005 ; fi 
